 ...
 *
 * @param type   动作类型：publish_help / publish_idle / publish_wanted / goto_publish（发布指引快捷跳转）
 * @param label  动作按钮文案（如"帮您发起求助"）
 * @param params 预填参数（title/description/category 等）；goto_publish 时含 type（help/idle/wanted）
 */
