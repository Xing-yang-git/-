      ...
      <el-header class="topbar">
        <div class="topbar-left">
          <span class="topbar-title" style="display:flex;align-items:baseline;gap:8px;">
            <span>翠湖花园 · 运营看板</span>
            <span class="text-sm text-secondary" style="white-space:nowrap;font-weight:400;">{{ today }}</span>
          </span>
        </div>
      ...
      <el-main>
        ...
        <div class="luxe-section">
          ...
          <div class="two-col-luxe">
            ...
            <div class="stat-panel-luxe">
              ...
              <div class="stat-row">
                <div>
                  <div class="panel-value text-green">52<span style="font-size:18px;">次</span></div>
                  <div class="panel-label">已互助（68%）</div>
                </div>
                <div>
                  <div class="panel-value" style="color:var(--text-secondary);">24<span style="font-size:18px;">次</span></div>
            ...
            <div class="stat-panel-luxe">
              ...
              <div class="stat-row">
                <div>
                  <div class="panel-value text-green">38<span style="font-size:18px;">次</span></div>
                  <div class="panel-label">正常耗损</div>
                </div>
                <div>
                  <div class="panel-value text-orange">2<span style="font-size:18px;">次</span></div>
                  <div class="panel-label">损坏已赔偿</div>
                </div>
                <div>
                  <div class="panel-value text-red">1<span style="font-size:18px;">次</span></div>
        ...
        <div class="luxe-section">
          <div class="luxe-section-header">
            ...
            <span class="luxe-section-sub" style="cursor:pointer;color:var(--accent);font-weight:500;" @click="showAllRecords = true">全部互助 ›</span>
          </div>
        ...
        <el-dialog v-model="showAllRecords" title="全部互助记录" width="640px">
          <div class="filter-row" style="padding:0;margin-bottom:8px;">
            ...
            <span class="text-sm text-secondary">共 {{ filteredAllRecords.length }} 条</span>
          </div>
          <el-table :data="filteredAllRecords" size="small" max-height="400">
            ...
            <el-table-column prop="count" label="互助次数" width="100" align="center" />
          </el-table>
          <template #footer>
  ...
  chartInstance.setOption({
    ...
    series: [
      ...
      },
      {
        ...
        type: 'bar',
        data: d.done,
        itemStyle: { color: 'rgba(0,113,227,0.25)', borderRadius: [4,4,0,0] },
        barWidth: 16
      }
    ]
  });
