  ...
  <el-container class="admin-layout">
    ...
    <el-container>
      <el-header class="topbar">
        <div class="topbar-left" style="display:flex;align-items:baseline;gap:8px;">
          <span class="topbar-title">物业运营端</span>
          <span class="text-sm text-secondary" style="white-space:nowrap;font-weight:400;">{{ todayWithTime }}</span>
        </div>
      ...
      <el-main>
        ...
        <!-- 核心操作 -->
        <div class="section-label-title">核心操作</div>
        <div class="launcher-grid">
          <div class="launch-card" @click="$router.push('/audit')">
            <div class="card-icon" style="background:rgba(0,113,227,0.08);color:var(--accent);">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="7" r="3"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><circle cx="18" cy="7" r="2.5"/><path d="M15 14.5a3.5 3.5 0 0 1 4 3.5v2"/></svg>
            </div>
          ...
          <div class="launch-card" @click="$router.push('/content')">
            <div class="card-icon" style="background:rgba(255,149,0,0.08);color:var(--orange);">
            ...
            <div class="card-desc">巡查 · 违规下架 · 物业代发</div>
          </div>
          <div class="launch-card" @click="$router.push('/dashboard')">
            <div class="card-icon" style="background:rgba(52,199,89,0.08);color:var(--green);">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="4" rx="1"/><rect x="14" y="11" width="7" height="10" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></svg>
            </div>
            <div class="card-title">数据看板</div>
            <div class="card-desc">运营概览 · 互助趋势 · 损坏统计</div>
          </div>
        </div>

        <!-- 数据与记录 -->
        <div class="section-label-title">数据与记录</div>
        <div class="launcher-grid">
          <div class="launch-card" @click="$router.push('/records')">
            <div class="card-icon" style="background:rgba(0,113,227,0.04);color:var(--accent);">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 14l2 2 4-4"/></svg>
            </div>
            <div class="card-title">互助记录</div>
            <div class="card-desc">住户互助档案 · 按户查询 · 时间筛选</div>
          </div>
          <div class="launch-card" @click="$router.push('/export')">
            <div class="card-icon" style="background:rgba(0,113,227,0.04);color:var(--accent);">
            ...
            <div class="card-desc">报表导出 · 自动备份 · 导出日志</div>
          </div>
        </div>
...
.section-label-title:first-of-type {
  margin-top: 0;
}
